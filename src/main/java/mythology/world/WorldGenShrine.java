...
public class WorldGenShrine extends WorldGenerator{
	...
	public boolean generate(World world, Random rand, int x, int y, int z)
	{
		...
		world.setBlock(x + 4, y, z, block);
		world.setBlock(x + 5, y, z, block);
		world.setBlock(x + 6, y, z, block);
		world.setBlock(x + 7, y, z, block);
		world.setBlock(x + 8, y, z, block);
		world.setBlock(x + 9, y, z, block);
		...
		world.setBlock(x + 9, y + 6, z, block);
		world.setBlock(x + 9, y, z + 1, block);
		world.setBlock(x + 9, y, z + 2, block);
		world.setBlock(x + 9, y, z + 3, block);
		world.setBlock(x + 9, y, z + 4, block);
		world.setBlock(x + 9, y, z + 5, block);
		world.setBlock(x + 9, y, z + 6, block);
		world.setBlock(x + 8, y, z + 6, block);
		world.setBlock(x + 7, y, z + 6, block);
		world.setBlock(x + 6, y, z + 6, block);
		world.setBlock(x + 5, y, z + 6, block);
		world.setBlock(x + 4, y, z + 6, block);
		world.setBlock(x + 3 , y, z + 6, block);
		world.setBlock(x + 2 , y, z + 6, block);
		world.setBlock(x , y, z + 6, block);
		world.setBlock(x , y, z + 6, block);
		...
		world.setBlock(x , y + 6, z + 6, block);
		world.setBlock(x , y, z + 5, block);
		world.setBlock(x , y, z + 4, block);
		...
		world.notifyBlockChange(x + 1, y, z, block);
		world.notifyBlockChange(x + 2, y, z, block);
		world.notifyBlockChange(x + 3, y, z, block);
		world.notifyBlockChange(x + 4, y, z, block);
		world.notifyBlockChange(x + 5, y, z, block);
		world.notifyBlockChange(x + 6, y, z, block);
		world.notifyBlockChange(x + 7, y, z, block);
		world.notifyBlockChange(x + 8, y, z, block);
		world.notifyBlockChange(x + 9, y, z, block);
		...
		world.notifyBlockChange(x + 9, y + 6, z, block);
		world.notifyBlockChange(x + 9, y, z + 1, block);
		world.notifyBlockChange(x + 9, y, z + 2, block);
		world.notifyBlockChange(x + 9, y, z + 3, block);
		world.notifyBlockChange(x + 9, y, z + 4, block);
		world.notifyBlockChange(x + 9, y, z + 5, block);
		world.notifyBlockChange(x + 9, y, z + 6, block);
		world.notifyBlockChange(x + 8, y, z + 6, block);
		world.notifyBlockChange(x + 7, y, z + 6, block);
		world.notifyBlockChange(x + 6, y, z + 6, block);
		world.notifyBlockChange(x + 5, y, z + 6, block);
		world.notifyBlockChange(x + 4, y, z + 6, block);
		world.notifyBlockChange(x + 3 , y, z + 6, block);
		world.notifyBlockChange(x + 2 , y, z + 6, block);
		world.notifyBlockChange(x , y, z + 6, block);
		world.notifyBlockChange(x , y, z + 6, block);
		...
		world.notifyBlockChange(x , y + 6, z + 6, block);
		world.notifyBlockChange(x , y, z + 5, block);
		world.notifyBlockChange(x , y, z + 4, block);
		world.notifyBlockChange(x , y, z + 3, block);
		world.notifyBlockChange(x , y, z + 2, block);
		world .notifyBlockChange (x + 9, y + 1, z + 6, block);
		world .notifyBlockChange (x + 9 , y + 2, z + 6, block);
		world .notifyBlockChange (x + 9 , y + 3, z  + 6, block);
		world .notifyBlockChange (x + 9 , y + 4, z + 6, block);
